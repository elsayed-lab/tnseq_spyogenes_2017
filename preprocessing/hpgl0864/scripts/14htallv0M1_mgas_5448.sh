...
#SBATCH --job-name=htallv0M1_mgas_5448
#SBATCH --mem=6G
#SBATCH --cpus-per-task=4
#SBATCH --output=/cbcb/nelsayed-scratch/atb/tnseq/spyogenes_5448v3/preprocessing/hpgl0864/outputs/htallv0M1_mgas_5448.sbatchout

echo "####Started /cbcb/nelsayed-scratch/atb/tnseq/spyogenes_5448v3/preprocessing/hpgl0864/scripts/14htallv0M1_mgas_5448.sh at $(date)" >> outputs/log.txt
cd /cbcb/nelsayed-scratch/atb/tnseq/spyogenes_5448v3/preprocessing/hpgl0864 || exit

## Counting the number of hits in outputs/bowtie_mgas_5448/hpgl0864-v0M1.bam for each feature found in /cbcbhomes/abelew/libraries/genome/mgas_5448.gff
...
htseq-count -q -f bam -s no   \
  outputs/bowtie_mgas_5448/hpgl0864-v0M1.bam \
  /cbcbhomes/abelew/libraries/genome/mgas_5448.gff \
  1>outputs/bowtie_mgas_5448/hpgl0864-v0M1_v0M1.count 2>outputs/bowtie_mgas_5448/hpgl0864-v0M1_htseq.err && \
    xz -f -9e outputs/bowtie_mgas_5448/hpgl0864-v0M1_v0M1.count

## The following lines give status codes and some logging
echo $? > outputs/status/htallv0M1_mgas_5448.status
echo "###Finished ${SLURM_JOBID} 14htallv0M1_mgas_5448.sh at $(date), it took $(( SECONDS / 60 )) minutes." >> outputs/log.txt
