...
#SBATCH --job-name=btdef_mgas_5448
#SBATCH --mem=6G
#SBATCH --cpus-per-task=4
#SBATCH --output=/cbcb/nelsayed-scratch/atb/tnseq/spyogenes_5448v3/preprocessing/hpgl0864/outputs/btdef_mgas_5448.sbatchout

echo "####Started /cbcb/nelsayed-scratch/atb/tnseq/spyogenes_5448v3/preprocessing/hpgl0864/scripts/10btdef_mgas_5448.sh at $(date)" >> outputs/log.txt
...
## /cbcbhomes/abelew/libraries/genome/indexes/mgas_5448 using arguments:  .

mkdir -p outputs/bowtie_mgas_5448 && sleep 3 && bowtie /cbcbhomes/abelew/libraries/genome/indexes/mgas_5448   \
  -p 1 -q hpgl0864-trimmed_ca_ta.fastq \
  --un outputs/bowtie_mgas_5448/hpgl0864-def_unaligned_mgas_5448.fastq \
  --al outputs/bowtie_mgas_5448/hpgl0864-def_aligned_mgas_5448.fastq \
  -S outputs/bowtie_mgas_5448/hpgl0864-def.sam \
  2>outputs/bowtie_mgas_5448/hpgl0864-def.err \
  1>outputs/bowtie_mgas_5448/hpgl0864-def.out

## The following lines give status codes and some logging
echo $? > outputs/status/btdef_mgas_5448.status
echo "###Finished ${SLURM_JOBID} 10btdef_mgas_5448.sh at $(date), it took $(( SECONDS / 60 )) minutes." >> outputs/log.txt
